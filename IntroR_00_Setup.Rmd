...
location for it. We will be working with the spiders dataset so perhaps name it `R_SpidersLab` or something similar. This will be your **working directory** for the class. 
4. Click on `Create project`.
5. Inside your working directory, create a folder called **data**
6. Copy the following files into your data folder

>```{r, echo=FALSE,eval=TRUE,results='show'}
knitr::kable(data.frame(FILES=list.files("./data")),justify="left",row.names=FALSE,col.names="")
```
